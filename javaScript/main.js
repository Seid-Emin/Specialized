$(document).ready(function () {
    ...
    // ACORDEON SPECS INDIVIDUAL BIKES
    $(".specs-section-title-table").click(function () {
        var specsTitle = $(this);
        specsTitle.next().toggle();
        specsTitle.find('.chevronUp').toggle();
        specsTitle.find('.chevronDown').toggle();
    });

    $(".bike-specs-right-table-title").click(function () {
        var specsTopTitle = $(this);
        $('.specs-table-wrap').toggle();
        specsTopTitle.find('.chevronUp').toggle();
        specsTopTitle.find('.chevronDown').toggle();
    });
    ...
    for (var i = 0; i < pageNames.length; i++) {
        var currentPageName = pageNames[i];
